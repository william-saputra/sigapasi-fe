...
import type { TeacherAvailabilityResponseDTO, BulkAvailabilityRequestDTO } from '@/interfaces/schedules/availability.types'

export const availabilityService = {
    // Mengambil data ketersediaan guru yang sedang login
    getAvailability: () => 
        apiService.get<TeacherAvailabilityResponseDTO>('/availability'),
