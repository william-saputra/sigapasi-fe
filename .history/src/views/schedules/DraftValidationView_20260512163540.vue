...
<<<<<<< HEAD
          <p class="text-sm font-medium text-gray-500 ml-13">Draft ID: <span class="font-mono text-gray-400">{{ draftId }}</span></p>
        </div>
        
        <div class="flex gap-3 mt-4 md:mt-0">
          <button @click="onBackToDraft" class="rounded-xl border border-gray-300 bg-white px-5 py-2.5 text-sm font-bold text-gray-700 shadow-sm hover:bg-gray-50 hover:text-emerald-700 transition-all">
            Kembali ke Draft
          </button>
          <button @click="onSave" :disabled="isLoading" class="rounded-xl bg-emerald-600 px-6 py-2.5 text-sm font-bold text-white shadow-md shadow-emerald-600/20 hover:bg-emerald-700 disabled:opacity-60 transition-all flex items-center gap-2">
            <span>Simpan</span>
...
<<<<<<< HEAD
      <div v-if="isLoading" class="flex min-h-[400px] flex-col items-center justify-center rounded-2xl bg-white border border-gray-100 shadow-sm">
        <span class="inline-block h-10 w-10 animate-spin rounded-full border-4 border-emerald-100 border-t-emerald-600"></span>
        <p class="mt-4 text-sm font-semibold text-gray-500 animate-pulse">Menghitung validasi seluruh kelas...</p>
      </div>

      <div v-else-if="error" class="rounded-2xl border border-red-200 bg-red-50 p-10 text-center shadow-sm">
        ...
        <button @click="onBackToDraft" class="rounded-xl bg-red-600 px-6 py-2.5 text-sm font-bold text-white hover:bg-red-700 shadow-sm">
=======
      <div
        v-if="isLoading"
...
<<<<<<< HEAD
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
          <div class="relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <div class="text-xs font-bold uppercase tracking-widest text-gray-400 mb-1">Total Kelas</div>
          ...
          <div class="relative overflow-hidden rounded-2xl border border-emerald-200 bg-emerald-50/50 p-6 shadow-sm">
            <div class="text-xs font-bold uppercase tracking-widest text-emerald-600/70 mb-1">Jadwal Lengkap</div>
          ...
          <div class="relative overflow-hidden rounded-2xl border border-red-200 bg-red-50/50 p-6 shadow-sm">
            <div class="text-xs font-bold uppercase tracking-widest text-red-600/70 mb-1">Belum Lengkap</div>
            <div class="text-4xl font-black text-red-700">{{ invalidClasses }}</div>
            <div class="absolute -right-4 -top-4 opacity-10 text-red-600">
              <svg class="w-24 h-24" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
=======
        <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
          <div
...
<<<<<<< HEAD
        <div class="flex items-center justify-between rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
          <div class="flex items-center gap-4">
            <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600">
              <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z"/></svg>
            </div>
            <div>
              <label class="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-1.5">Filter Berdasarkan Kelas</label>
              <select
          ...
          <div class="overflow-x-auto">
            <table class="w-full text-sm">
              <thead class="bg-gray-50/80 border-b border-gray-200">
                <tr>
<<<<<<< HEAD
                  <th class="px-6 py-4 text-center text-xs font-bold text-gray-500 uppercase tracking-wider w-40">Kelas</th>
                  <th class="px-6 py-4 text-center text-xs font-bold text-gray-500 uppercase tracking-wider w-48 border-l border-gray-200">Status</th>
                  <th class="px-8 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider border-l border-gray-200">
=======
                  <th
...
<<<<<<< HEAD
                        <svg class="h-12 w-12 text-gray-300 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
=======
                        <svg
...
<<<<<<< HEAD
                      <div class="inline-flex h-12 items-center justify-center rounded-xl bg-gray-100 px-5 text-base font-black text-gray-800">
                        {{ cls.className }}
                      </div>
                    </td>
...
<<<<<<< HEAD
                      ...
                      >
                        <span v-if="cls.isValid" class="h-1.5 w-1.5 rounded-full bg-emerald-600"></span>
                        <span v-else class="h-1.5 w-1.5 rounded-full bg-red-600 animate-pulse"></span>
...
<<<<<<< HEAD
                              <div class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-md bg-white text-red-500 shadow-sm">
                              ...
                              <span class="font-semibold text-gray-700">{{ target.subjectName }}</span>
                            </div>
                            <div class="flex flex-col items-end">
                              <span class="text-xs font-bold text-red-600 bg-red-100/80 px-2 py-1 rounded-md">
=======
                              <div
...
<<<<<<< HEAD
                          ...
                          <span class="font-semibold">Semua target jam pelajaran telah terpenuhi.</span>
=======
                          <svg
                            class="h-5 w-5"
                            fill="none"
