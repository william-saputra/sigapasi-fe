...
<<<<<<< HEAD
    ...
    case 'SMA': return 'bg-orange-100 text-orange-800 border-orange-200'
...
<<<<<<< HEAD
      ...
      <!-- Page Header & Actions -->
      <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-gray-200 pb-4 gap-4">
        <div>
          <h2 class="text-3xl font-bold text-gray-800">Mata Pelajaran</h2>
          <p class="mt-1 text-gray-500">Kelola daftar mata pelajaran untuk setiap jenjang pendidikan.</p>
        </div>
        <button 
=======
      <!-- Page Header & Actions -->
...
>>>>>>> 8060b4c18f8acbd1761af22f3b0b8ed43e8c7cb6
      ...
      <!-- Main Data Table -->
<<<<<<< HEAD
      <div class="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-gray-200 min-h-[300px]">
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Nama Mata Pelajaran</th>
              <th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-gray-900">Jenjang</th>
              <th scope="col" class="py-3.5 pl-3 pr-4 text-right text-sm font-semibold text-gray-900 sm:pr-6">Aksi</th>
=======
      <div
...
<<<<<<< HEAD
              <td colspan="3" class="py-12 text-center text-sm text-gray-500">Tidak ada data mata pelajaran.</td>
            </tr>
            <tr v-for="subject in filteredSubjects" :key="subject.id" class="transition-colors hover:bg-gray-50">
              <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">
                {{ subject.name }}
              </td>
              <td class="whitespace-nowrap py-4 px-3 text-sm">
                <span :class="['inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold', getBadgeColor(subject.level)]">
                  {{ subject.level }}
                </span>
              </td>
...
>>>>>>> 8060b4c18f8acbd1761af22f3b0b8ed43e8c7cb6
          ...
          <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
              ...
              >
<<<<<<< HEAD
                <div v-if="isModalOpen" class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
=======
                <div
                  v-if="isModalOpen"
...
<<<<<<< HEAD
                    ...
                    <div class="space-y-4">
                      <div>
                        <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Nama Mata Pelajaran</label>
                        <div class="mt-2">
                          <input 
                            v-model="form.name"
                            type="text" 
...
>>>>>>> 8060b4c18f8acbd1761af22f3b0b8ed43e8c7cb6
                      ...
                      <div>
<<<<<<< HEAD
                        <label for="level" class="block text-sm font-medium leading-6 text-gray-900">Jenjang</label>
                        <div class="mt-2">
                          <select 
                            v-model="form.level"
                            id="level" 
