        ...
        <div class="modal-body">
          <form @submit.prevent="submitModal">
            ...
            <div class="form-group">
              <label class="form-label"> Nama Periode <span class="required-star">*</span> </label>
              <select
                v-model="form.semesterId"
                class="form-control"
                :class="{ 'is-invalid': errors.semesterId }"
              >
                <option value="">Pilih salah satu periode</option>
                <option v-for="s in availableSemesters" :key="s.id" :value="s.id">
                  {{ s.name }}
                </option>
              </select>
