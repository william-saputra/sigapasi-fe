...
async function fetchReviewTasks() {
  ...
  try {
    ...
    fetchError.value = 'Gagal memuat daftar tugas evaluasi. Pastikan server berjalan dan Anda sudah login.'
  } finally {
  ...
  <AppLayout>
    ...
    <AppCard>
      <div class="greeting-card">
        <h3 class="greeting-title">Halo
          , {{ userName }}! 👋</h3>
        <p class="greeting-subtitle">
        Berikut adalah ringkasan kinerja dan daftar tugas evaluasi Anda.</p>
      </div>
    </AppCard>
