      ...
      <div class="modal">
        ...
        <div class="modal-body">
          <form @submit.prevent="submitModal">
            <!-- Nama Periode: input UUID semester (endpoint /api/semesters belum tersedia di BE) -->
            <div class="form-group">
              <label class="form-label">Semester ID <span class="required-star">*</span></label>
              <input
              ...
              />
              <div class="note">Masukkan UUID semester yang valid dari database.</div>
              <div v-if="errors.semesterId" class="error-message show">
                Semester ID wajib diisi.
              </div>
            </div>
